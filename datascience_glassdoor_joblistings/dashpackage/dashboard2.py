...
from dashpackage.display import layout
...
app.layout = html.Div(
    [
        ...
        html.Div([
            ...
            html.Span("GlassDoor Visualiser", className='app-title'),
            
            html.Div(
                html.Img(src='https://i.imgur.com/c5zuULy.png', height="100%")
                ,style={"float":"left","height":"90%"})
            ],
        ...
        html.Div([
            ...
            dcc.Tabs(
                ...
                children=[
                    dcc.Tab(label="Display", value="display_tab"),
...
#this says that the parameter tab = tabs.value using the ids
#and that the return value gets set to the html of tab_content.children
@app.callback(Output("tab_content", "children"), [Input("tabs", "value")])
def render_content(tab):
    print('RENDER LAYOUT', layout)
    if tab == "display_tab":
        return layout
